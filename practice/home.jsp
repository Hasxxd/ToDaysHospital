...
<body>
  <div class="wrapper">
    ...
    <header>
      <div class="logo">
        <img src="${pageContext.request.contextPath}/resources/images/todayhos.png" alt="오늘의 병원 로고" />
      </div>
  ...
  <div id="signupModal" class="modal" style="display:none;">
    <div class="modal-content">
      ...
      <iframe id="signupIframe" src="../signup/signup.jsp" frameborder="0" style="width:100%; height: 1000px;"></iframe>
    </div>
  </div>
  ...
  <div id="successModal" class="modal" style="display:none;">
    <div class="modal-content" style="text-align: center; padding: 40px; max-width: 400px;">
      ...
      <img src="https://cdn-icons-png.flaticon.com/512/4145/4145155.png" alt="Success Icon" style="width: 100px; height: 100px; margin-top: 20px;">
    </div>
  </div>
