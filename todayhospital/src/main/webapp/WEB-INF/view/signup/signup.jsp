  ...
  <div class="container">
    ...
    <form id="signup-form" novalidate>
      ...
      <div class="input-group with-icon email-group">
        ...
        <button type="button" id="sendAuthEmail" class="auth-btn">인증 메일 전송</button>
      </div>

      <!-- 인증번호 입력 -->
      <div class="input-group" id="authCodeContainer" style="display: none; gap: 5px;">
        <input type="text" id="emailAuthCode" placeholder="인증번호 입력" />
        <button type="button" id="verifyAuthCode" class="auth-btn">인증 확인</button>
      </div>

      <!-- 인증 상태 메시지 -->
      <div id="emailAuthMessage" style="margin-top: 5px; font-weight: bold;"></div>

      <!-- ✅ 개발용 인증코드 표시 -->
      <div id="devGeneratedCode" style="color: #999; font-size: 13px; margin-top: 3px;"></div>
