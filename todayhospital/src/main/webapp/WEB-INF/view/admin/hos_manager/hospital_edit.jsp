    ...
    <div class="edit-container">
        ...
        <form action="hospital_update.jsp" method="post" id="hospitalEditForm">
            ...
            <select id="nightServiceYN" name="nightServiceYN">
                <option value="1" <%= "1".equals(hospital.getNightServiceYN()) ? "selected" : "" %>>예</option>
                <option value="0" <%= "0".equals(hospital.getNightServiceYN()) ? "selected" : "" %>>아니오</option>
            </select>

            <label for="wheelchairYN">휠체어출입가능여부</label>
            <select id="wheelchairYN" name="wheelchairYN">
                <option value="1" <%= "1".equals(hospital.getWheelchairYN()) ? "selected" : "" %>>예</option>
                <option value="0" <%= "0".equals(hospital.getWheelchairYN()) ? "selected" : "" %>>아니오</option>
            </select>
